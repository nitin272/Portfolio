...
const AnimatedBackground = () => {
  ...
  const handleMouseHover = (e: SplineEvent) => {
    // Disable hover interactions in skills section
    if (!splineApp || selectedSkill?.name === e.target.name || activeSection === "skills") return;
    ...
    if (e.target.name === "body" || e.target.name === "platform") {
      ...
      try {
        ...
        // Variables don't exist in Spline file, ignore
      }
    } else {
