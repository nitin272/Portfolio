...
using use = useUsing("use")`,
  ...
  [SkillNames.RUST]: {
    ...
    name: "rust",
    label: "Rust",
    shortDescription: "Memory safe and blazingly fast! 🦀⚡",
    color: "#CE422B",
  ...
  [SkillNames.RUBY]: {
    ...
    name: "ruby",
    label: "Ruby on Rails",
    shortDescription: "Convention over configuration, making devs happy! 💎🚂",
    color: "#CC0000",
  ...
  [SkillNames.REACTNATIVE]: {
    ...
    name: "reactnative",
    label: "React Native",
    shortDescription: "Build native mobile apps with React! 📱⚛️",
    color: "#61DAFB",
  ...
  [SkillNames.FLUTTER]: {
    ...
    name: "flutter",
    label: "Flutter",
    shortDescription: "Google's UI toolkit for beautiful native apps! 🎨🚀",
    color: "#02569B",
